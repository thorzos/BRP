...
@AllArgsConstructor
@ToString
public class PropertyEditRestDto {
    ...
    public PropertyEditDto updateWithId(Long id) {
        return new PropertyEditDto(id, this.countryCode, this.postalCode, this.area, this.address);
    }
}
